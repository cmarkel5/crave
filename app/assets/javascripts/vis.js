...
var Bubbles, root, texts, innerRadius, outerRadius;
...
Bubbles = function() {
  ...
  maxRadius = 65;
  rScale = d3.scale.sqrt().range([0, innerRadius]);
  rValue = function(d) {
    if (d.viewsCount == 0) { 
      return 0;
    }
    else {
      return Math.round((parseInt(d.purchaseCount)/parseInt(d.viewsCount)) * 100);
    }
  };
  idValue = function(d) {
    return d.name;
